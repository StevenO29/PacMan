...
class Program
{
	static void Main(string[] args)
	{
		...
		int statusInky = 0;
		int statusPinky = 0;
		int batasStatusBlinky = 41;
		int batasStatusPinky = 45;
		int batasStatusInky = 59;
		int tujuanBlinky = 0;
		int tujuanPinky = 0;
		int tujuanInky = 0;
		int score = 0;
		...
		//GAME
		///Game akan dijalankan selama score < 1 7 9 0 0 / semua  makanan  habis  
		///Jika  PACMAN  makan  GHOST / POWER  UP , score  tidak  bertambah  
		///Score  akan  bertambah 5 0 / food  
		...
		while (true)
		{
			while (score < 17900) //perulangan game
			{
				...
				//scatter Blinky
				if (statusBlinky <= batasStatusBlinky) //BLINKY jalan sebanyak 41 steps
				{
					if (statusBlinky <= batasStatusBlinky - 1) //BLINKY jalan sebanyak 40 steps
					{
				...
				//scatter Pinky
				if (statusPinky <= batasStatusPinky) //PINKY jalan sebanyak 45 steps
				{
					if (statusPinky <= batasStatusPinky - 1) //PINKY jalan sebanyak 44 steps
					{
				...
				{
					//scatter inky
					if (statusInky <= batasStatusInky) //INKY jalan sebanyak 59 steps
					{
						if (statusInky <= batasStatusInky - 1) //INKY jalan sebanyak 58 steps
						{
				...
				//chase Blinky
				if (statusBlinky > batasStatusInky) //Keluar dari Scatter
				{
				...
				//chase Pinky
				if (statusPinky > batasStatusPinky)
				{
