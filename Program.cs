    ...
    static void Main(string[] args)
    {
        ...
        while (score < 17900) //perulangan game
        {
            ...
            while (status <= 40)
            {
                ...
                {
                    if (entityPosition[posisiBlinkyHorizontal + 3, posisiBlinkyVertical] != 1 && posisiBlinkyVertical != 4) //atas ada wall, kanan gaada wall
                    {
                        ...
                        {
                            Console.Write(" ");
                            entityPosition[posisiBlinkyHorizontalOld, posisiBlinkyVerticalOld] = 0;
                        }
                        else if (entityPosition[posisiBlinkyHorizontalOld, posisiBlinkyVerticalOld] == 2)
                        {
                            Console.ForegroundColor = ConsoleColor.White;
                            Console.Write(".");
                            entityPosition[posisiBlinkyHorizontalOld, posisiBlinkyVerticalOld] = 2;
                        }
                    }
                    else if (entityPosition[posisiBlinkyHorizontal + 3, posisiBlinkyVertical] == 1)//atas wall, kanan wall
                    {
                    ...
                    else if (entityPosition[posisiBlinkyHorizontal - 3, posisiBlinkyVertical] != 1 && posisiBlinkyVertical == 4)
                    {
                        posisiBlinkyHorizontal -= 3;
                        Console.SetCursorPosition(posisiBlinkyHorizontal, posisiBlinkyVertical);
                        Console.ForegroundColor = ConsoleColor.Red;
                        ...
                        else if (entityPosition[posisiBlinkyHorizontalOld, posisiBlinkyVerticalOld] == 7)
                        {
                            Console.ForegroundColor = ConsoleColor.DarkYellow;
                            Console.Write("o");
                            entityPosition[posisiBlinkyHorizontalOld, posisiBlinkyVerticalOld] = 7;
                        }
                    }

                }
                else if (entityPosition[posisiBlinkyHorizontal, posisiBlinkyVertical - 1] != 1 && posisiBlinkyHorizontal != 90) //atas gaada wall, x e bukan d 90
                {
                    posisiBlinkyVertical--;
                    Console.SetCursorPosition(posisiBlinkyHorizontal, posisiBlinkyVertical);
                    Console.ForegroundColor = ConsoleColor.Red;
                ...
                else if (entityPosition[posisiBlinkyHorizontal, posisiBlinkyVertical + 1] != 1 && posisiBlinkyHorizontal == 90) //atas gaada wall, bawah gaada wall, x e d 90
                {
